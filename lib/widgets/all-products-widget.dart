...
class AllProductsWidgets extends StatefulWidget {
  ...
  @override
  State<AllProductsWidgets> createState() => _AllProductsWidgets();
}

class _AllProductsWidgets extends State<AllProductsWidgets> {
  @override
                ...
                itemBuilder: (context, index) {
                  ...
                  return Row(
                    children: [
                      GestureDetector(
                        onTap: () => Get.to(() =>
                            ProductsDetailsScreen(productModel: productModel)),
                        child: Padding(
